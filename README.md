...
- [Reference architecture of an SAP BTP CAP application using GPT Models of OpenAI](https://github.com/SAP/sap-btp-reference-architectures/tree/main/hyperscalers/openai)
- [SAP-samples/azure-openai-aicore-cap-api: SAP BTP, AI Core - consuming and exposing a CAP API](https://github.com/SAP-samples/azure-openai-aicore-cap-api)
...
- [Integrating OpenAI Chat Completion into an existing SAP Build App](https://blogs.sap.com/2023/03/31/integrating-openai-chat-completion-into-an-existing-sap-build-app/)
...
- [Innovate with Azure Open AI and SAP: A Simple use case | LinkedIn](https://www.linkedin.com/pulse/innovate-azure-open-ai-sap-simple-use-case-ravi-gangampalli/)
...
- [Allies in AI  Thomas Saueressig and Scott Guthrie talking about Microsoft Cloud & AI](https://www.linkedin.com/posts/thsaueressig_innovation-artificialintelligence-partnership-activity-7099777950912262145-2hIh)
...
## Videos
- [YouTube: A Cool use of Open AI in SAP GUI Editor](https://www.youtube.com/watch?v=V_ye3Xs2LG4)
- [Building Intelligent Interactions with SAP UI5 and Chat GPT](https://www.youtube.com/watch?v=-pjy2gNUZcQ)
- [SAP on Azure Podcast - #138 - The one with Azure Open AI and SAP S/4HANA (Chan Jin Park)](https://youtu.be/GeY2haei_kw?t=1032)
